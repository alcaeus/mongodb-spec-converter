...
final class RetryableReadsSuiteConverter implements TestSuiteConverterInterface
{
    public static function getInputDir(): string
    {
        return __DIR__ . '/../../../spec/source/retryable-reads/tests/legacy';
    }

    public static function getOutputDir(): string
    {
        return __DIR__ . '/../../../spec/source/retryable-reads/tests/unified/';
    }
    ...
    {
        return new RetryableReadsRootConverter();
    }
    ...
    public static function getItemConverters(): array
    {
        return [
            ...
            'tests' => new ListConverter(new RetryableReadsTestConverter(), true),
        ];
    }
}
